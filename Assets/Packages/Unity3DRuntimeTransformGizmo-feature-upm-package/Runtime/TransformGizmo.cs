	...
	public class TransformGizmo : MonoBehaviour
	{
        ...
        void DrawQuads(List<Vector3> lines, Color color)
        {
            ...
            for (int i = 0; i < lines.Count; i += 4)
            {
                ...
                Vector3 v2 = lines[i + 2];
                Vector3 v3 = lines[i + 3];
		...
		void SetMaterial()
		{
			...
			{
				lineMaterial = new Material(Shader.Find("Custom/URP/Lines"));
				outlineMaterial = new Material(Shader.Find("Custom/URP/Outline"));
			}
		}
